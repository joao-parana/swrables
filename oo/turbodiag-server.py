...
#
# Atenção : Esta implementação só funciona no Python 2.7+
#
# Para invocar o servidor faça: ./turbodiag-server.py 8193 json
#
...
class RequestHandler(SimpleHTTPServer.SimpleHTTPRequestHandler):
    ...
    def list_directory(self, path):
        ...
        f.write('<html class="no-js" lang="">\n')
        f.write('  <head>\n')
        f.write('    <meta charset="utf-8">\n')
        f.write('    <title>Directory listing for %s</title>\n' % displaypath)
        f.write('    <meta http-equiv="x-ua-compatible" content="ie=edge">\n')
        f.write('    <!-- Other HEAD content hear -->\n')
        f.write('    <!-- Use https://github.com/h5bp/html5-boilerplate for robust structure -->\n')
        f.write('  </head>\n')
